    ...
    <div className="w-full min-h-screen relative bg-[#F7F5F3] overflow-x-hidden flex flex-col justify-start items-center">
      <div className="relative flex flex-col justify-start items-center w-full">
        <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] relative flex flex-col justify-start items-start min-h-screen">
            ...
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[50px] pb-10 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-1 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
              ...
              <div className="mt-10 flex justify-center items-center z-10">
                <button
                  ...
                  className="px-6 py-2 text-sm font-medium text-neutral-700 dark:text-neutral-300 border border-neutral-300 dark:border-neutral-700 rounded-md hover:border-neutral-900 dark:hover:border-neutral-100 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors"
                >
                  Start for free
                </button>
              </div>
          ...
          {/* Footer */}
          <footer className="w-full dark:border-neutral-800 py-8 px-4 mt-1 relative z-10">
